...
public class REF extends Segment {
    ...
    @Definition(required = Required.REQUIRED, position = 1, minLength = 2, maxLength = 3, codeValues = {"0B", "1C", "1D", "1J", "4A", "CT", "EL", "EO", "HPI", "JD", "N5", "N7", "Q4", "SY", "TJ"})
    public String getReferenceIdentificationQualifier() {return collection[1];}

    @Definition(required = Required.NOTUSED, position = 2, minLength = 1, maxLength = 50)
    public String getReferenceIdentification() {return collection[2];}

    @Definition(required = Required.SITUATIONAL, position = 3, minLength = 1, maxLength = 80)
    public String getDescription() {return collection[3];}

    @Definition(required = Required.NOTUSED, position = 4, minLength = 1, maxLength = 1)
