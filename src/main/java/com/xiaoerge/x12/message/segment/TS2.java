...
public class TS2 extends Segment {
    ...
    public String getQuantity() { return collection[7]; }

    @Definition(position = 8, minLength = 1, maxLength = 18)
    public String getMonetaryAmount8() { return collection[8]; }

    @Definition(position = 9, minLength = 1, maxLength = 18)
    public String getMonetaryAmount9() { return collection[9]; }

    @Definition(position = 10, minLength = 1, maxLength = 15)
    public String getQuantity2() { return collection[10]; }

    @Definition(position = 11, minLength = 1, maxLength = 15)
    public String getQuantity3() { return collection[11]; }

    @Definition(position = 12, minLength = 1, maxLength = 15)
    public String getQuantity4() { return collection[12]; }

    @Definition(position = 13, minLength = 1, maxLength = 15)
    public String getQuantity5() { return collection[13]; }

    @Definition(position = 14, minLength = 1, maxLength = 15)
    public String getQuantity6() { return collection[14]; }

    @Definition(position = 15, minLength = 1, maxLength = 18)
    public String getMonetaryAmount10() { return collection[15]; }

    @Definition(position = 16, minLength = 1, maxLength = 15)
    public String getQuantity7() { return collection[16]; }

    @Definition(position = 17, minLength = 1, maxLength = 18)
    public String getMonetaryAmount11() { return collection[17]; }

    @Definition(position = 18, minLength = 1, maxLength = 18)
    public String getMonetaryAmount12() { return collection[18]; }

    @Definition(position = 19, minLength = 1, maxLength = 18)
    public String getMonetaryAmount13() { return collection[19]; }
    ...
    public void setQuantity(String s) { collection[7] = s; }
    public void setMonetaryAmount8(String s) { collection[8] = s; }
    public void setMonetaryAmount9(String s) { collection[9] = s; }
    public void setQuantity2(String s) { collection[10] = s; }
    public void setQuantity3(String s) { collection[11] = s; }
    public void setQuantity4(String s) { collection[12] = s; }
    public void setQuantity5(String s) { collection[13] = s; }
    public void setQuantity6(String s) { collection[14] = s; }
    public void setMonetaryAmount10(String s) { collection[15] = s; }
    public void setQuantity7(String s) { collection[16] = s; }
    public void setMonetaryAmount11(String s) { collection[17] = s; }
    public void setMonetaryAmount12(String s) { collection[18] = s; }
    public void setMonetaryAmount13(String s) { collection[19] = s; }
}
