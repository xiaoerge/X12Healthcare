...
public class BHT extends Segment {
    ...
    public String getHierarchicalStructureCode() { return getByPosition(); }

    @Definition(position = 2, minLength = 2, maxLength = 2)
    public String getTransactionSetPurposeCode() { return getByPosition(); }
    ...
    public String getTransactionTypeCode() { return getByPosition(); }
