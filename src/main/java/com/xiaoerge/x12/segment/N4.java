...
public class N4 extends Segment {
    ...
    public String getPostalCode() { return getByPosition(); }
    ...
    public String getLocationQualifier() { return getByPosition(); }

    @Definition(position = 6, minLength = 1, maxLength = 30)
    public String getLocationIdentifier() { return getByPosition(); }

    @Definition(position = 7, minLength = 1, maxLength = 3)
    public String getCountrySubdivisionCode() { return getByPosition(); }
