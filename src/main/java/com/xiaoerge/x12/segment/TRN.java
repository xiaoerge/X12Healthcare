...
public class TRN extends Segment {
    ...
    public String getTraceTypeCode() { return getByPosition(); }
    ...
    public String getOriginatingCompanyIdentifier() { return getByPosition(); }

    @Definition(position = 4, minLength = 1, maxLength = 50)
    public String getReferenceIdentification2() { return getByPosition(); }
