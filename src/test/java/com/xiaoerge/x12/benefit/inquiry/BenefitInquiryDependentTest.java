...
public class BenefitInquiryDependentTest {
    ...
    public void testParseBenefitDepedentInquiry() {
        ...
        Assert.assertEquals("TRN*1*93175-012547*9877281234~", dependent.getTraceNumber().get(0).toString());
        Assert.assertEquals("TRN*1*109834652831*WXYZCLEARH*REALTIME~", dependent.getTraceNumber().get(1).toString());
        Assert.assertEquals(2, dependent.getTraceNumber().size());
        ...
        Assert.assertEquals("DTP*291*D8*20060501~", dependent.getDate().get(0).toString());
    ...
    public void testCreateBenefitDependentInquiry() {
        ...
        dependent.setTraceNumber(new ArrayList<TRN>());
        dependent.getTraceNumber().add(new TRN("TRN*1*93175-012547*9877281234~"));
        dependent.getTraceNumber().add(new TRN("TRN*1*109834652831*WXYZCLEARH*REALTIME~"));
        ...
        dependent.setDate(new ArrayList<DTP>());
        dependent.setDemographicInformation(new DMG("DMG*D8*19430519~"));
        dependent.getDate().add(new DTP("DTP*291*D8*20060501~"));
